...
class register3_activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        linkReturn.setOnClickListener ({
            val intent = Intent(this@register3_activity, register2_activity::class.java)
            startActivity(intent)
        })

        linkNext.setOnClickListener ({
            val intent = Intent(this@register3_activity, register4_activity::class.java)
            startActivity(intent)
        })
